...
<div className="">
    ...
    <div className=' relative   pl-[3vw] overflow-hidden w-screen h-screen  text-white bg-[#192A36] flex'>
     <div>
        <div className="pt-14">  
        ...
        <div className="h-[320px] sm:flex mt-5 items-center justify-center -translate-x-1/2 -translate-y-1/2 hidden w-[320px] bg-[#398DC8] rounded-full absolute top-1/2 left-1/2">
    ...
    <div className="sticky top-0">
    <div className=' relative   pl-[3vw] overflow-hidden w-screen h-screen  text-white bg-[#3A9076] flex'>
    <div>
       <div className="pt-14">  
         <h2 className='text-4xl text-start font-semibold'>Guiding You At Every Step!</h2>
         <p className='text-slate-100 mt-4'>Our Top Mentors show you the way,
    ...
    <div className=' relative pl-[3vw] overflow-hidden w-screen h-screen  text-white bg-[#80467D] flex'>
     <div>
        <div className="pt-14">  
          <h2 className='text-4xl text-start font-semibold'>Guiding You At Every Step!</h2>
          <p className='text-slate-100 mt-4'>Our Top Mentors show you the way,
        ...
        <div className="h-[320px] sm:flex mt-5 items-center justify-center -translate-x-1/2 -translate-y-1/2 hidden w-[320px] bg-[#C779E2] rounded-full absolute top-1/2 left-1/2">
          <p className='text-white text-lg'>“Your <br /> <span className='text-4xl font-bold'>Aspiration <br /></span >is our <span className='text-4xl font-bold'> goal”</span>
</p>
        </div>
